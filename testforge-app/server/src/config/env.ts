...
export const env = {
  ...
  // Comma-separated so one deployment can allow several frontends — in practice the hosted
  // API needs both the GitHub Pages origin (https://idk11091.github.io) and, when debugging
  // against real data, a local dev client. Origins are scheme+host only, never a path.
